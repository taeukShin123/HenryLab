...
[CustomEditor(typeof(GridShufflerInScene))]
public class shufflerInSceneEditor : Editor {
	
	GridShufflerInScene myScript;
	...
	void OnEnable () {
		...
		GameObject_Prop = serializedObject.FindProperty ("GoSimpleMazePiece");
		...
		myScript = (GridShufflerInScene)target;
